...
<head>
    ...
    <meta name="description" content="4th Wedding form">
    <meta name="author" content="David Mark">
    <title>Wedding Form-4 | The Wedding</title>
...
<body>
	...
	<div class="container-fluid p-0">
	    <div class="row no-gutters row-height">
	        <div class="col-lg-6 background-image" data-background="url(img/wedding.jpg)">
	            <div class="content-left-wrapper opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.6)">
	                
	                
	                <!-- /social -->
	                <div>
	                    <h1>Wedding Form | Stage 4 (The Wedding)</h1>
	                    <p>Lets work on the wedding day.</p>
	            ...
	            <div class="container my-auto py-5">
	                <div class="row">
	                    <div class="col-lg-9 col-xl-7 mx-auto">
	                        <h4 class="mb-3">Wedding Form | Stage 4 (Wedding Day)</h4>
	                        <form class="input_style_1" action= "php/weddingday.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
	                                ...
	                                <input type="time" name="wedding_time" id="wedding_time" class="form-control" required>
	                            </div>
								<div class="form-group">
	                                <label for="wvenue">Wedding venue</label>
	                                <input type="text" name="wvenue" id="wvenue" class="form-control" required>
	                            </div>
                                <div class="form-group">
	                                <label for="rvenue">Reception venue</label>
	                                <input type="text" name="rvenue" id="rvenue" class="form-control" required>
	                            </div>
                                <div class="form-group">
	                                <label for="reception_time">Reception time</label>
	                                <input type="time" name="reception_time" id="reception_time" class="form-control" required>
	                            </div>
