...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Link Gen | Admin | 2geda</title>
        ...
        <div id="wrapper">
            ...
            <div class="navbar-custom">
                    ...
                    <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
                        ...
                        <li>
                            <h4 class="page-title-main">Link Generator</h4>
                        </li>
                    ...
                    <!-- Start Content-->
                       ...
                       <?php
                        if(isset($_POST['link'])){
                            ...
                            $order=$_POST['order'];
                            $pack=$_POST['pack'];
                            $gen="2gedaplanner.epizy.com/lovus/forms/".$stage."?id=".$order."&package=".$pack;
                        }
                       ?>
                    <form action="" method="post">
                    <label for="change"><h2>Generate form link</h2></label>
                        ...
                        <div class="form-group">
                                    ...
                                    <option value="contact-bride.php">Stage 1</option>
                                    <option value="contact-groom.php">Stage 2</option>
                                    <option value="contact-ourjourney.php">Stage 3</option>
                                    <option value="contact-weddingday.php">Stage 4</option>
                                    <option value="contact-parents.php">Stage 5</option>
                                    <option value="contact-bridesmaid.php">Stage 6</option>
                                    <option value="contact-groomsmen.php">Stage 7</option>
                                    </select>
	                                
	                            </div>
                                <div class="form-group">
	                                <label for="id">Input Order ID</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <option value="BASIC%20PACKAGE">Basic</option>
                                    <option value="STANDARD%20PACKAGE">Standard</option>
                                    <option value="CLASSIC%20PACKAGE">Classic</option>
                                    <option value="PREMIUM%20PACKAGE">Premium</option>
                                    </select>
	                                
	                            </div><br>
                                <button type="submit" name="link">Generate link</button>
