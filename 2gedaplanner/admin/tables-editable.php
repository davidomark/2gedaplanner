...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Orders | Admin | 2geda</title>
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <form action="status.php?user=superadmin" method="post">
                    <label for="change"><h2>Change Order Status</h2></label>

                        <div class="form-group">
	                                <label for="id">Input Row ID</label>
